      ...
      <ol class="flex gap-1">
        ...
        <li aria-current="page">
          <div class="flex items-center">
            <span class="text-main text-lg">User Info</span>
          </div>
        </li>
      </ol>
    </nav>
    ...
    <div class="flex flex-wrap lg:flex-nowrap gap-6">
      ...
      <div class="w-full overflow-hidden lg:w-1/2 bg-white shadow-[0px_2px_13px_0px_rgba(202,_229,_233,_0.048)] rounded-[1.375rem]">
        <div class="h-20 bg-gradient-to-b from-main from-40% to-main/25 flex justify-center">
          ...
          <img class="h-20 w-20 object-cover rounded-full border-2 border-white top-10 relative" src="{{$user->photo}}" alt="user image">
        </div>
        ...
        <div class="flex flex-col gap-4 p-6">
          <div class="flex flex-col gap-4">
            <div class="flex">
              <span class="block w-1/4 text-[#808080]">Name</span>
              <span class="text-darkGray">{{$user->name}}</span>
            </div>
            <div class="flex">
              <span class="block w-1/4 text-[#808080]">Age</span>
            ...
            <div class="flex">
              <span class="block w-1/4 text-[#808080]">Email</span>
              <span class="text-darkGray">{{$user->email}}</span>
            </div>
            <div class="flex">
              <span class="block w-1/4 text-[#808080]">Phone</span>
          ...
          <div class="flex flex-col gap-4">
            <div class="flex">
              <span class="block w-1/4 text-[#808080]">Case</span>
      ...
      <!-- Reviews -->
      <div class="w-full overflow-hidden lg:w-1/2 bg-white shadow-[0px_2px_13px_0px_rgba(202,_229,_233,_0.048)] rounded-[1.375rem]">
        <p class="text-darkBlue text-[1.375rem] p-5 border-b border-light-blue-200">Reviews</p>
        <div class="px-5">
      ...
      <div class="bg-white shadow-[0px_2px_13px_0px_rgba(202,_229,_233,_0.48)] rounded-2xl">
        <div class="flex items-center justify-between px-5 py-4">
          ...
          <div class="flex items-center gap-4">
            <p class="text-[1.1875rem] text-darkGray">Total Bookings: <span class="font-bold">{{$user->user_booking->count()}}</span></p>
          </div>
        </div>
