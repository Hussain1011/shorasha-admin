...
@section('content')
        ...
        <div class="grid grid-cols-1 gap-4 sm:gap-5 lg:gap-6">
            ...
            <div class="card px-4 pb-4 sm:px-5">
                ...
                <form id="deleteForm" action="{{ route('language/update') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
                ...
                <div class="row">
                    ...
                    <!-- <div class="max-w-m form-group" style="padding-top: 2%">
                        ...
                        <img src="{{url('/')}}/public/{{$language->photo}}">
                ...
                {{-- <div class="max-w-m  " style="padding-top: 2%  ;float-right">
                    <a href="{{ route('/language/create') }}" style="color: green"
