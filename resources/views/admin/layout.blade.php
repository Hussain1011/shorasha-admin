...
<body>
    <div class="flex bg-main">
        ...
        <div class="w-56 bg-main h-screen sticky top-0 py-10 px-4">
            ...
            <div class="mb-12">
                <a href="{{ route('index') }}">
                    <img src="{{ asset('images/images/logo-sh.png') }}" alt="website logo">
                </a>
            </div>
            <!-- Nav-Items -->
            <nav>
                <ul>
                    ...
                    <li class="mb-1">
                        <a class="{{ Route::currentRouteName() === '/consultant/list' ? ' bg-white' : 'text-white hover:bg-white/15' }} rounded-[0.8125rem] flex items-center gap-2 px-4 py-2"
                            ...
                            <img style="background-color:#a0b46f"
                    ...
                    <li class="mb-1">
                        <a class="{{ Route::currentRouteName() === '/category/list' ? ' bg-white' : 'text-white hover:bg-white/15' }} rounded-[0.8125rem] flex items-center gap-2 px-4 py-2"
                            href="{{ route('/category/list') }}">
                            <img src="{{ asset('images/images/nav-revenue.svg') }}" alt="revenue icon">
                            <span
                                class="{{ Route::currentRouteName() === '/category/list' ? ' text-main font-bold' : 'text-white ' }}">
                                {{ __('lang.category') }}</span>
                        </a>
                    </li>
                    <li class="mb-1">
                        <a class="{{ Route::currentRouteName() === '/language/list' ? ' bg-white' : 'text-white hover:bg-white/15' }} rounded-[0.8125rem] flex items-center gap-2 px-4 py-2"
                            href="{{ route('/language/list') }}">
                            <img src="{{ asset('images/images/nav-revenue.svg') }}" alt="revenue icon">
                            <span
                                class="{{ Route::currentRouteName() === '/language/list' ? ' text-main font-bold' : 'text-white ' }}">
                                {{ __('lang.language') }}</span>
                        </a>
                    </li>
                    <li class="mb-1">
                        <a class="{{ Route::currentRouteName() === '/accent/list' ? ' bg-white' : 'text-white hover:bg-white/15' }} rounded-[0.8125rem] flex items-center gap-2 px-4 py-2"
                            href="{{ route('/accent/list') }}">
                            <img src="{{ asset('images/images/nav-revenue.svg') }}" alt="revenue icon">
                            <span
                                class="{{ Route::currentRouteName() === '/accent/list' ? ' text-main font-bold' : 'text-white ' }}">
                                {{ __('lang.accent') }}</span>
                        </a>
                    </li>
                    <li class="mb-1">
        ...
        <div class="bg-secondary w-full rounded-s-[2rem] p-6 flex flex-col gap-6">
            ...
            <div
                ...
                <div class="flex items-center">
                    ...
                    @else
                        <a href="{{ route('setLocale') }}" class="flex gap-3 items-center">
                            <img class="w-6 h-6 rounded-full" src="{{ asset('images/images/qatar.png') }}"
                                 ...
                                 <div class="p-3 bg-[#EFFAFC] rounded-[0.8125rem] flex gap-3">
                                    ...
                                    <div class="flex flex-col gap-1">
                                        ...
                                        <div class="flex items-center gap-2">
                                            ...
                                            <span
                                                class="text-[#808080] text-sm">{{ $notification->created_at }}</span>
                                        </div>
                                    </div>
                                </div> </a>
                            @endforeach
            ...
            <div class="bg-white py-4 px-6 shadow-[0px_5px_20px_0px_rgba(98,_202,_217,_0.10)] rounded-[1.125rem]">
                <p class="text-[0.875rem] text-darkGray">© 2024 <a class="text-main" href="#">Shorasha</a>. All
                    Rights Reserved.</p>
            </div>
        </div>
    </div>
