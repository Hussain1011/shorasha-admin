...
@section('content')
    <div class="bg-secondary w-full rounded-s-[2rem] p-6 flex flex-col gap-6">
        ...
        <!-- Edit Form -->
        <form action="{{ route('admin.user.update',['id'=> $user->id]) }}" method="POST" class="space-y-6" enctype="multipart/form-data">
            @csrf
            @method('post')
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <div class="flex">
                            ...
                            <input type="date" id="age" name="date_birth"
                                value="{{ $user->personal ? $user->personal?->date_birth : null }}"
                                class="py-3 px-4 rounded-[0.8125rem] bg-[#EAF8FA] text-darkGray border-none focus:ring-main focus:border-main block w-full">
                        </div>
						--}}
                        <div class="flex">
                        ...
                        <div class="flex">
                            ...
                            <input type="mobile" id="mobile" name="mobile" value="{{ $user->mobile }}"
                                class="py-3 px-4 rounded-[0.8125rem] bg-[#EAF8FA] text-darkGray border-none focus:ring-main focus:border-main block w-full">
                        </div>
