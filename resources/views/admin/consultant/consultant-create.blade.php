                ...
                <div class="flex flex-col gap-4 p-6">
                    <div class="flex flex-col gap-4">
                        ...
                        <div class="flex">
                            ...
                            <input type="mobile" id="mobile" name="mobile" value="+974"
                                class="py-3 px-4 rounded-[0.8125rem] bg-[#EAF8FA] text-darkGray border-none focus:ring-main focus:border-main block w-full">
                        </div>
                        @error('mobile')
                            <span class="text-tiny+ text-error" style="color:red">{{ $message }}</span>
						...
						<div class="flex">
                            ...
                            <textarea id="intro_text" name="intro_text" value="{{ old('intro_text') }}"
                                class="py-3 px-4 rounded-[0.8125rem] bg-[#EAF8FA] text-darkGray border-none focus:ring-main focus:border-main block w-full"></textarea>
                        </div>
                        @error('fees')
                            <span class="text-tiny+ text-error" style="color:red">{{ $message }}</span>
                        @enderror
