    ...
    <div>
        <div class="bg-white shadow-[0px_2px_13px_0px_rgba(202,_229,_233,_0.48)] rounded-2xl">
            <div class="flex items-center justify-between px-5 py-4">
                <span class="text-darkBlue text-[1.3125rem]">{{ trans('lang.category') }}</span>
                <div class="flex items-center gap-4">
                    <a class="w-10 h-10 bg-main rounded-xl flex justify-center items-center" href="{{ route('admin.category.create')  }}">
                            ...
                            <tr class="text-[#363636] hover:bg-[#EFF8FA]">
                                ...
                                <td class="border-b border-light-blue-200 px-5 py-4">
                                    <div class="flex gap-3 items-center">
                                        ...
                                        <form id="{{$row->id}}" action="{{ route('category/delete', ['id' => $row->id]) }}"
                                            method="POST">
                                            @csrf
                                            @method('POST')
