...
@section('content')
      ...
      <div class="flex gap-6 flex-wrap lg:flex-nowrap">
        ...
        <div class="w-full lg:w-2/3">
          <div class="bg-white shadow-[0px_2px_13px_0px_rgba(202,_229,_233,_0.48)] rounded-[1.375rem]">
            <p class="text-darkBlue text-xl font-semibold px-4 py-5 border-b border-light-blue-200">{{__("lang.booking_details")}}</p>
            <div class="flex flex-col gap-4 p-4">
              <div class="flex flex-col gap-4">
                <div class="flex">
              ...
              <div class="flex flex-col gap-4">
                ...
                <div class="flex">
                  ...
                  <span class="text-darkGray font-semibold text-xl">{{$row?->doctor?->personal?->fees}}</span>
                </div>
                <div class="flex">
                  <span class="block w-1/4 text-[#808080]">{{__('lang.status')}}</span>
