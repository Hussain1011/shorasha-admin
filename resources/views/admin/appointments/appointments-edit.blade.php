...
@section('content')
    ...
    <form action="{{ route('admin.appointments.update',['id'=> $row->created]) }}" method="POST" class="space-y-6">
                ...
                <div class="flex flex-col gap-4">
                    <!-- <div class="flex">
                        <label for="booking_type"
                            class="block w-1/4 text-[#808080]">{{ __('lang.type') }}</label>
                    ...
                    <div class="flex">
                        <label for="start_time" class="block w-1/4 text-[#808080]">{{ __('lang.date_time') }}</label>
        ...
        <div class="flex justify-end">
            <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">{{__('lang.save')}}</button>
        </div>
    </form>
@endsection
