...
<div class="flex flex-col justify-between h-full">
    <div class="bg-white shadow-[0px_2px_13px_0px_rgba(202,_229,_233,_0.48)] rounded-[1.375rem] overflow-x-auto">
        <div class="flex justify-between items-center p-6 pb-0">
            <p class="text-darkBlue text-xl font-bold">{{trans('lang.total')}}</p>
            <div>
              ...
              <input class="text-light-blue-150 bg-white border border-light-blue-50 px-3 py-1 rounded-lg" type="date" name="" id="from_date">
                ...
                <div id="dropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44">
                    {{-- <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdown-button">
                        <li>
                            <a href="#" class="block px-4 py-2 hover:bg-gray-100">{{trans('lang.monthly')}}</a>
                        </li>
                        <li>
                            <a href="#" class="block px-4 py-2 hover:bg-gray-100">{{trans('lang.yearly')}}</a>
                        </li>
                    </ul> --}}
                </div>
            ...
            <table class="w-full text-center">
              <thead>
                <tr class="text-darkGray font-bold">
                  ...
                  <th class="border-t border-b border-light-blue-200 px-5 py-4">@lang('lang.paid')</th>
                  <th class="border-t border-b border-light-blue-200 px-5 py-4">@lang('lang.refund')</th>
                  <th class="border-t border-b border-light-blue-200 px-5 py-4">@lang('lang.total')</th>
  ...
  <script>
    $('#getDuration').click(function(){
      ...
      window.location= '{{url("admin/revenue")}}/'+from_date+'/'+to_date+'';
    });
  </script>
@endsection
