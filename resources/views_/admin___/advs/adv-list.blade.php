                    ...
                    <tbody>
                        @foreach ($advs as $row)
                            <tr class="text-[#363636] hover:bg-[#EFF8FA]">
                                ...
                                <td class="border-b border-light-blue-200 px-5 py-4"><img src="{{ Url('/').'/'.$row->image_en }}" width=200></td>
                                <td class="border-b border-light-blue-200 px-5 py-4"><img src="{{ Url('/').'/'.$row->image_ar }}" width=200></td>
