        ...
        <table class="w-full text-center">
          <thead>
            <tr class="text-darkGray font-bold">
              <th class="border-t border-b border-light-blue-200 px-5 py-4">{{trans('lang.no')}}</th>
              ...
              <th class="border-t border-b border-light-blue-200 px-5 py-4">{{trans('lang.counseling_type')}}</th>
              ...
              <th class="border-t border-b border-light-blue-200 px-5 py-4">{{trans('lang.action')}}</th>
            </tr>
          </thead>
          <tbody>
            @foreach ($rows as $row)
            <tr class="text-[#363636] font-semibold hover:bg-[#EFF8FA]">
                ...
                <td class="border-b border-light-blue-200 px-5 py-4">{{$row->doctor_notes}}</td>
