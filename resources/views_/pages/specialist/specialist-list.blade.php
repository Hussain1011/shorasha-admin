            ...
            <div>
                <div class="flex items-center justify-between">
                    ...
                    {{-- <div class="flex items-center space-x-2 sm:space-x-3"> --}}
                        ...
                        href="{{ route('registerView') }}">Create account</a>                    </div> --}}
                        <div class="mt-2 px-4">
                            <a
                            href="{{ route('/specialist/create') }}" style="color: green"
                            ...
                            <tbody>
                                ...
                                @foreach ($specialists as $specialist)
                                    ...
                                    <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                                        ...
                                        <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                            <a data-toggle="tooltip" data-placement="top" title="Edit" href="{{ url("specialist/{$specialist->id}") }}" class="btn btn-icon btn-sm">
                                                <i class="fas fa-pen"></i>
                                            </a>

                                        </td>
                                        <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                            <form id="deleteForm" action="{{ route('specialist/delete', ['id' => $specialist->id]) }}" method="POST">
                                                @csrf
                                                @method('post')
                                        ...
                                        {{-- <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                                <div :class="user.role_bg" x-text="user.role"
