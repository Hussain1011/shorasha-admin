...
<div>
    <div class="bg-white shadow-[0px_2px_13px_0px_rgba(202,_229,_233,_0.48)] rounded-2xl">
      <div class="flex items-center justify-between px-5 py-4">
        <span class="text-darkBlue text-[1.3125rem]">{{trans('lang.appointments')}}</span>
      </div>
      <div class="overflow-x-auto">
        <table class="w-full text-center">
          <thead>
            <tr class="text-darkGray font-bold">
              <th class="border-t border-b border-light-blue-200 px-5 py-4">#</th>
              <th class="border-t border-b border-light-blue-200 px-5 py-4">{{trans('lang.user')}}</th>
              <th class="border-t border-b border-light-blue-200 px-5 py-4">{{trans('lang.consultant')}}</th>
              <th class="border-t border-b border-light-blue-200 px-5 py-4">{{trans('lang.method')}}</th>
              <th class="border-t border-b border-light-blue-200 px-5 py-4">{{trans('lang.date_time')}}</th>
              <th class="border-t border-b border-light-blue-200 px-5 py-4">{{trans('lang.type')}}</th>
              <th class="border-t border-b border-light-blue-200 px-5 py-4">{{trans('lang.status')}}</th>
              <th class="border-t border-b border-light-blue-200 px-5 py-4">{{trans('lang.notes')}}</th>
              <!-- <th class="border-t border-b border-light-blue-200 px-5 py-4">{{trans('lang.price')}}</th> -->
              <th class="border-t border-b border-light-blue-200 px-5 py-4">{{trans('lang.payment')}}</th>
              <th class="border-t border-b border-light-blue-200 px-5 py-4">{{trans('lang.options')}}</th>
            </tr>
          </thead>
          <tbody>
            @foreach ($rows as $row)
            <tr class="text-[#363636] font-semibold hover:bg-[#EFF8FA]">
                ...
                <td class="border-b border-light-blue-200 px-5 py-4">{{$row->notes}}</td>
                <!-- <td class="border-b border-light-blue-200 px-5 py-4">{{$row->fees}}</td> -->
