...
@section('content')
    ...
    {{-- <header class="bg-[#E8EBEB]">
        ...
        class="text-[#5B99A2] text-xl p-4 w-32" >Current</a>
    ...
    <header class="bg-[#E8EBEB] flex justify-between items-center">
        <div>
                ...
                <button href="{{ route('admin.consultant.index.new') }}"
                    class="text-main text-xl p-4 w-32 relative before:content-[''] before:absolute before:bottom-0 before:start-0 before:h-[4px] before:w-full before:bg-main before:rounded-full">New</button>
