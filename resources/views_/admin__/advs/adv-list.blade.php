    ...
    <div>
        <div class="bg-white shadow-[0px_2px_13px_0px_rgba(202,_229,_233,_0.48)] rounded-2xl">
            <div class="flex items-center justify-between px-5 py-4">
                <span class="text-darkBlue text-[1.3125rem]">{{ trans('lang.advs') }}</span>
                <div class="flex items-center gap-4">
                    

                    <!-- Add User -->
                    <a class="w-10 h-10 bg-main rounded-xl flex justify-center items-center"
                        href="{{ route('advs.create') }}">
                ...
                <table class="w-full text-start">
                    <thead>
                        <tr class="text-darkGray font-bold">
                            ...
                            <th class="border-b border-light-blue-200 px-5 py-4">
                                <div class="flex justify-between items-center">
                                    <span>{{trans('lang.created_at')}}</span>
                                    <div class="w-4 flex flex-col">
                                        <img class="-mb-1" src="{{ asset('images/images/table-sort-asc') }}.svg"
                                            alt="sort asc">
                                        <img src="{{ asset('images/images/table-sort-desc') }}-active.svg" alt="sort desc">
                            ...
                            <th class="border-b border-light-blue-200 px-5 py-4">
                                <div class="flex justify-between items-center">
                                    <span>{{trans('lang.updated_at')}}</span>
                                    <div class="w-4 flex flex-col">
                                        <img class="-mb-1" src="{{ asset('images/images/table-sort-asc') }}.svg"
                                            alt="sort asc">
                                        <img src="{{ asset('images/images/table-sort-desc') }}-active.svg" alt="sort desc">
                            ...
                            <th class="text-start border-b border-light-blue-200 px-5 py-4">{{trans('lang.action')}}</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach ($advs as $row)
                            <tr class="text-[#363636] hover:bg-[#EFF8FA]">
                                ...
                                <td class="border-b border-light-blue-200 px-5 py-4">{{ ($row->type == 'user')? 'user' : 'doctor' }}</td>
                                <td class="border-b border-light-blue-200 px-5 py-4"><img src="{{ Url('/').'/public/'.$row->image_en }}" width=200></td>
                                <td class="border-b border-light-blue-200 px-5 py-4"><img src="{{ Url('/').'/public/'.$row->image_ar }}" width=200></td>
                                <td class="border-b border-light-blue-200 px-5 py-4">{{ ($row->active = 1)? 'active' : 'not active' }}</td>
                                <td class="border-b border-light-blue-200 px-5 py-4"> {{ $row->created_at }}</td>
                                <td class="border-b border-light-blue-200 px-5 py-4"> {{ $row->updated_at }}</td>
