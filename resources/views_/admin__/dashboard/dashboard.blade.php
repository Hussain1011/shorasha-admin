    ...
    <div class="flex gap-6">
        <div
            ...
            <div class="flex flex-col gap-2">
                ...
                <span class="text-normalGray">{{__('lang.Total Users')}}</span>
            </div>
        </div>
        <div
            class="bg-white shadow-[0px_2px_13px_0px_rgba(202,_229,_233,_0.48)] rounded-2xl w-1/3 p-3 flex items-center gap-4">
            ...
            <div class="flex flex-col gap-2">
                ...
                <span class="text-normalGray">{{__('lang.Total Consultants')}}</span>
            </div>
        </div>
        <div
            class="bg-white shadow-[0px_2px_13px_0px_rgba(202,_229,_233,_0.48)] rounded-2xl w-1/3 p-3 flex items-center gap-4">
    ...
    <div class="flex gap-6">
        <div
            ...
            <div class="flex flex-col gap-2">
                ...
                <span class="text-normalGray">{{__('lang.Completed Appointments')}}</span>
            </div>
        </div>
        <div
            class="bg-white shadow-[0px_2px_13px_0px_rgba(202,_229,_233,_0.48)] rounded-2xl w-1/3 p-3 flex items-center gap-4">
            ...
            <div class="flex flex-col gap-2">
                ...
                <span class="text-normalGray">{{__('lang.Upcoming Appointments')}}</span>
            </div>
        </div>
        <div
            class="bg-white shadow-[0px_2px_13px_0px_rgba(202,_229,_233,_0.48)] rounded-2xl w-1/3 p-3 flex items-center gap-4">
            ...
            <div class="flex flex-col gap-2">
                ...
                <span class="text-normalGray">{{__('lang.Canceled Appointments')}}</span>
            </div>
        </div>
    </div>
    ...
    <div class="flex gap-6">
        <div class="flex flex-col w-1/3 gap-6">
            ...
            <div class="p-5 bg-white rounded-2xl shadow-[0px_2px_13px_0px_rgba(202,_229,_233,_0.48)] flex flex-col gap-6">
                <span class="text-normalGray text-xl">New Users</span>
                <div class="flex gap-5 items-center">
                    ...
                    <div>
                        ...
                        <p class="text-[#808080]">Visitors this month</p>
                    </div>
                </div>
            </div>
            <!-- Weekly Consultations -->
            <div class="bg-white rounded-2xl shadow-[0px_2px_13px_0px_rgba(202,_229,_233,_0.48)]">
                <p class="text-darkBlue text-[1.375rem] font-bold px-5 py-3">Weekly Consultations</p>
        ...
        <div class="bg-white rounded-2xl shadow-[0px_2px_13px_0px_rgba(202,_229,_233,_0.48)] w-2/3">
            <p class="p-5 text-darkBlue text-[1.375rem] font-bold border-b border-light-blue-200">New Appointments</p>
            <table class="w-full text-center">
                <thead>
                    <tr class="text-darkGray font-bold">
                        <th class="p-3 border-b border-light-blue-200">User</th>
                        <th class="p-3 border-b border-light-blue-200">Consultant</th>
                        <th class="p-3 border-b border-light-blue-200">Method</th>
                        <th class="p-3 border-b border-light-blue-200">Date and Time</th>
                        <th class="p-3 border-b border-light-blue-200">Action</th>
                    </tr>
                </thead>
                <tbody>
