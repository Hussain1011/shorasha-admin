...
@section('content')
    <div class="flex flex-wrap lg:flex-nowrap gap-6">
            ...
            <div class="bg-white shadow-[0px_2px_13px_0px_rgba(202,_229,_233,_0.48)] rounded-[1.375rem]">
                ...
                <div class="p-3 flex flex-col justify-center items-center gap-7">
                    <div class="text-center flex flex-col gap-2">
                        <p class="text-[#90B5BA]">{{ __('lang.Consultation Fees') }}</p>
                    ...
                    @if ($user->personal?->doctor_verified == 0)
                        <div class="flex gap-4">
                            ...
                            <button class="border border-main text-main rounded-[0.8125rem] py-1.5 w-32 text-lg"
                                data-modal-target="default-modal" data-modal-toggle="default-modal">Reject</button>
                        </div>
                        @else
                        <form id="{{ $user->id }}"
        ...
        <div class="w-full lg:w-1/2 flex flex-col gap-6">
                ...
                <div class="px-5">
                    ...
                    <div class="flex justify-between py-4 border-b border-light-blue-200">
                        <div class="flex gap-2 items-center">
                            ...
                            <p class="text-darkGray text-lg">{{ __('lang.ID Card or Passport') }}</p>
                        </div>
                        <div class="flex items-center gap-5">
                    ...
                    <div class="flex justify-between py-4 border-b border-light-blue-200">
                        <div class="flex gap-2 items-center">
                            ...
                            <p class="text-darkGray text-lg">{{ __('lang.Personal Photo') }}</p>
                        </div>
                        <div class="flex items-center gap-5">
                    ...
                    <div class="flex justify-between py-4">
                        <div class="flex gap-2 items-center">
                            ...
                            <p class="text-darkGray text-lg">{{ __('lang.Academic Certificate') }}</p>
                        </div>
                        <div class="flex items-center gap-5">
            ...
            <div class="bg-white shadow-[0px_2px_13px_0px_rgba(202,_229,_233,_0.48)] rounded-[1.375rem]">
                <p class="text-darkBlue text-[1.375rem] p-5 border-b border-light-blue-200">Specializations</p>
                <div class="px-5">
    ...
    {{-- <form action="{{ route('admin.doctor.transferred_amount') }}" method="POST" class="space-y-6">
        ...
        <div class="bg-white shadow-[0px_2px_13px_0px_rgba(202,_229,_233,_0.48)] rounded-2xl">
          <div class="flex items-center justify-between px-5 py-4">
            ...
            <span class="text-darkBlue text-[1.3125rem]">Booking Details</span>
            <div class="flex items-center gap-4">
              {{-- <p class="text-[1.1875rem] text-darkGray">Total Bookings: <span class="font-bold">{{$user->doctor_booking->count()}}</span></p> --}}
            </div>
          </div>
            ...
            <table class="w-full text-center">
              <thead>
                <tr class="text-darkGray font-bold">
                  <th class="border-y border-light-blue-200 px-5 py-4">{{ trans('lang.compleated booking count') }}</th>
                  <th class="border-y border-light-blue-200 px-5 py-4">{{ trans('lang.total_fees') }}</th>
                  <th class="border-y border-light-blue-200 px-5 py-4">{{ trans('lang.app_share') }}</th>
                  <th class="border-y border-light-blue-200 px-5 py-4">{{ trans('lang.doctor_debit') }}</th>
        ...
        <div class="bg-white shadow-[0px_2px_13px_0px_rgba(202,_229,_233,_0.48)] rounded-2xl">
          <div class="flex items-center justify-between px-5 py-4">
            <span class="text-darkBlue text-[1.3125rem]">Bookings</span>
            <div class="flex items-center gap-4">
              <p class="text-[1.1875rem] text-darkGray">Total Bookings: <span class="font-bold">{{$user->doctor_booking->count()}}</span></p>
            </div>
          </div>
            ...
            <table class="w-full text-center">
              <thead>
                <tr class="text-darkGray font-bold">
                  ...
                  <th class="border-y border-light-blue-200 px-5 py-4">{{ trans('lang.Counseling_Type') }}</th>
                  ...
                  <th class="border-y border-light-blue-200 px-5 py-4">{{ trans('lang.Action') }}</th>
                </tr>
              </thead>
              <tbody>
                {{-- $user->doctor_booking --}}
