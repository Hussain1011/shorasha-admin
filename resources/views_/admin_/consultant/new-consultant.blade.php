...
@section('content')
    ...
    <header class="bg-[#E8EBEB] flex justify-between items-center">
        <div>
                <!-- Border-Bottom Made with Before (to give it rounded effect) -->
                <a href="{{ route('/consultant/list') }}" class="text-[#5B99A2] text-xl p-4 w-32">Current</a>
                <button href="{{ route('admin.consultant.index.new') }}"
        ...
        <div class="flex gap-4 m-4">
            <a class="w-10 h-10 bg-main rounded-xl flex justify-center items-center" href="{{route('consultant.create')}}">
