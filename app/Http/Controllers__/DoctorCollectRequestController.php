...
class DoctorCollectRequestController extends Controller
{
    public function index(Request $request)
    {
        ...
        $collect_requests = DoctorCollectRequest::latest()->paginate($request->pagination ?? 10);
        return view('admin/collect/collect-requests-list')
        ->with('deleted',false)
    ...
    {
        $collection_request = DoctorCollectRequest::find($request->id);
